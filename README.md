...
- Next, after accepting the licensing agreement we moved forward to path setting as shown below. 2*
- After that the installation process occurred smoothly. 3*

4. Build Tools for Visual Studio 2022

- In the next step of our process, We downloaded the file "[Build Tools for Visual Studio 2022](https://aka.ms/vs/17/release/vs_BuildTools.exe)" mentioned below. 1*
...
- In the next step, We downloaded the file [Latest Python 3 Release - Python 3.10.7](https://www.python.org/downloads/release/python-3107/) 1*
...
- Next, We selected the checkbox "Checkout as is, commit as-is" stating how Git would treat line endings in the text files. *5
